...
class AUDACITY_APPLICATION_LOGIC_API AmplifyBase : public StatefulPerTrackEffect
{
public:
   static inline AmplifyBase *
   FetchParameters(AmplifyBase &e, EffectSettings &){ return &e; }
...
protected:
   // TODO review this
   struct AUDACITY_APPLICATION_LOGIC_API Instance :
...
protected:
static constexpr EffectParameter Ratio{ &AmplifyBase::mRatio,
   L"Ratio",            0.9f,       0.003162f,  316.227766f,   1.0f  };
// Amp is not saved in settings!
static constexpr EffectParameter Amp{ &AmplifyBase::mAmp,
   L"",                -0.91515f,  -50.0f,     50.0f,         10.0f };
static constexpr EffectParameter Clipping{ &AmplifyBase::mCanClip,
